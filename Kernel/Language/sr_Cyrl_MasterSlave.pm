...
package Kernel::Language::sr_Cyrl_MasterSlave;
...
sub Data {
    ...
    $Self->{Translation}->{'Defines dynamic field name for master ticket feature.'}
        = 'Дефинише динамички назив поља за функцију главног тикета.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Enables the advanced MasterSlave part of the feature.'}
        = 'Активира напредни део функције главни/зависни.';
    ...
    $Self->{Translation}->{'MasterSlave module for Ticket Bulk feature.'}
        = 'Модул главни/зависни за функцију масовне обраде тикета.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Sets if Master / Slave field must be selected by the agent.'}
        = 'Дефинише да ли поље Главни / Зависни мора бити подешено од стране оператера.';
